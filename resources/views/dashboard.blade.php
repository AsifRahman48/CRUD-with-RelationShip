...
@section('content')
    ...
    <section id="aa-product-category">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-md-push-2">
                                        ...
                                        <figure>
                                            @foreach($list->images as $image)
                                                <a class="aa-product-img" href="{{ route('cart_show',$list->id) }}">
                                                    <img src="{{ asset($image->image_url) }}" width='250px'
                                                         height='300px'/>
                                                </a>
                                            @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a
                                                            href="{{ route('cart_show',$list->id) }}">{{ $list->name }}</a>
                                                    </h4>
                                                    <span class="aa-product-price pb-5">{{$list->price}}TK</span>
